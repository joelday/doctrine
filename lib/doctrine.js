...
(function () {
    ...
    (function (exports) {
        ...
        function parseType(title, last, skipContent) {
        ...
        function TagParser(options, title) {
            ...
            if (this._options.trackIndexes) {
                this._tag.startIndex = index;
            }
            this._last = 0;
        ...
        TagParser.prototype.parseType = function () {
            ...
            if (isTypeParameterRequired(this._title)) {
                try {
                    this._tag.type = parseType(this._title, this._last, this._options.skipTypeContent);
                    if (!this._tag.type) {
            ...
            if (this._options.trackIndexes) {
                ...
                this._tag.type.startIndex = startIndex;
                this._tag.type.endIndex = index;
            }
        ...
        function parseTag(options) {
            ...
            var trackIndexes = options.trackIndexes;
            // skip to tag
            if (!skipToTag()) {
                return null;
            }
